...
$filecontent=file_get_contents("../files/ca-input/cashindex.csv.".date("Ymd",strtotime($date)));
if($filecontent){
...
mail("dbajpai@indxx.com","File Read Error!","cashprices.csv for today is not available ");
//exit;
}
$time = microtime();
$time = explode(' ', $time);
