...
$emailsids='';
$dbuseremailsids='';
$indxx=selectrow(array('id','name','code','curr'),'tbl_indxx_temp');
if(!empty($indxx))
{
...
/*echo '<script>document.location.href="http://97.74.65.118/icai/index.php?module=calcindxxclosing";</script>';
*/
?>
