 <div class="control-group"><label class="control-label">{$formParams.feild_label}{if $formParams.is_required eq '1'} <sup style="color:#F00;">*</sup>{/if}:</label><div class="controls"><input type="text" name="{$formParams.feild_code}" id="{$formParams.feild_code}" value="{$formParams.value}" class="input-xlarge" {$formParams.feildValues}/></div></span>
