...
<div class="controls"><select class="input-xlarge" style=" width:283px !important" tabindex="1"  name="{$formParams.feild_code}" id="{$formParams.feild_code}" {$Form_Params.feildValues}>
