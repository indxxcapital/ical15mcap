 ...
 var temp=confirm("Are you sure you want to delete this record ")
  if(temp)
   {	
	...
	window.location.href='index.php?module=holidays&event=delete&id='+id;
	}
	else{
	return false;
	}
...
$.ajax({
    url : "index.php?module=holidays&event=deleteindex",
    type: "POST",
    data : parameters,
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-table"></i>Holidays</h3>
                            </div>
                            <div class="box-content">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                        <a class="btn btn-circle show-tooltip" title="Add new record" href="index.php?module=holidays&event=addNew"><i class="icon-plus"></i></a>
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=holidays&event=edit&id={$point.id}"><i class="icon-edit"></i></a>
