...
<table class="table table-advance" id="table1">
    ...
    <tbody>
    	{foreach from=$tickerdata item=point key=k}
        <tr>
            ...
            <td>{if $point.dbstatus==0}<span class="label label-important">Not approved!</span>{else}<span class="badge badge-success">Approved</span>{/if}</td>
                <td>
                <div class="btn-group">
                    <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=commodityticker&event=view&id={$point.id}"><i class="icon-zoom-in"></i></a>
                    <!-- <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=commodityticker&event=edit&id={$point.id}"><i class="icon-edit"></i></a>-->
