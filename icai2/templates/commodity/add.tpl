...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-reorder"></i>Add New Commodity Ticker</h3>
                            </div>
 ...
 <p>
                 ...
                 <div class="form-actions">
                                       ...
                                       <button type="button" class="btn" name="cancel" id="cancel" onClick="document.location.href='{$BASE_URL}index.php?module=users';" >Back</button>
