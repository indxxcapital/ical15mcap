...
<table class="table table-advance">
 ...
 <a href="index.php?module={$currentClass}&event=approvetemp&id={$viewindexdata.0.id}"><button class="btn btn-success">Approve</button></a> {/if}
 

                                    <a href="index.php?module={$currentClass}"><button class="btn btn-inverse">Back</button></a>
 ...
 {if $viewindexdata.0.dbapprove==0 && $viewindexdata.0.adminapprove==1}<a href="index.php?module={$currentClass}&event=dbapprove&id={$viewindexdata.0.id}">   <button class="btn btn-primary">Approve</button></a>{/if}
