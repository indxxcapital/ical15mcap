 ...
 var temp=confirm("Are you sure you want to delete this record ")
  if(temp)
   {	
	...
	window.location.href='index.php?module=updaterequest&event=delete&id='+id;
	}
	else{
	return false;
	}
...
$.ajax({
    url : "index.php?module=updaterequest&event=deleteindex",
    type: "POST",
    data : parameters,
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-table"></i>Update Request</h3>
                            </div>
                            <div class="box-content">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                     {if $sessData.User.type==1 }   <a class="btn btn-circle show-tooltip" title="Add new record" href="index.php?module=updaterequest&event=addNew"><i class="icon-plus"></i></a>
...
<table class="table table-advance" id="table1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                <a class="btn btn-small show-tooltip" title="View" href="index.php?module=updaterequest&event=view&id={$point.id}"><i class="icon-zoom-in"></i></a>
                    <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=updaterequest&event=edit&id={$point.id}"><i class="icon-edit"></i></a>
