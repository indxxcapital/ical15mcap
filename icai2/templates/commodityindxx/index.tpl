...
<table class="table table-advance" id="table1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                    <a class="btn btn-small show-tooltip" title="View" href="index.php?module=commodityindxx&event=view&id={$point.id}"><i class="icon-zoom-in"></i></a>
                    <!--<a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=commodityindxx&event=edit&id={$point.id}"><i class="icon-edit"></i></a>-->
                    
                   <!-- index.php?module=commodityindxx&event=delete&id={$point.id}-->
