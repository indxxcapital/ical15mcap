...
$(function() {
        ...
        $('#addScnt').click( function() {
             $('<div class="controls step  controls-row"> <span class="formnumber">'+i+'</span><input type="text" placeholder="Security Name" class="span3" name="name['+i+']"><input type="text" name="isin['+i+']" placeholder="ISIN" class="span2"><input  name="ticker['+i+']" type="text" placeholder="Ticker" class="span2"><input type="text" placeholder="Weight"  name="weight['+i+']" class="span2"><input name="curr['+i+']" type="text" placeholder="Ticker Currency" class="span1"><input name="divcurr['+i+']" type="text" placeholder="Dividend Currency" class="span1">').appendTo(scntDiv);
                $('#totalfields').val(i);
				i++;
                return false;
        });
