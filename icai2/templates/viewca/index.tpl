 ...
 var temp=confirm("Are you sure you want to delete this record ")
  if(temp)
   {	
	...
	window.location.href='index.php?module=viewca&event=delete&id='+id;
	}
	else{
	return false;
	}
...
$.ajax({
    url : "index.php?module=viewca&event=deleteindex",
    type: "POST",
    data : parameters,
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-table"></i>{$ticker}</h3>
                            </div>
...
<!--            <td><a data-original-title="{$point.mnemonic}" data-content="{$sessData.variable[$point.mnemonic]}" data-placement="top" data-trigger="hover" class="show-popover" href="#">{$point.mnemonic}</a></td>-->
            ...
            <td>
                <div class="btn-group">
                    <a class="btn btn-small show-tooltip" title="View Fields" href="index.php?module=caindex&event=view&id={$point.id}"><i class="icon-zoom-in"></i></a>
