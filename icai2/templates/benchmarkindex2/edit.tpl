 ...
 <div class="col-lg-4 col-md-4 col-sm-4">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="thumb-pad2">
                <div class="thumbnail"> 
                <div class="caption">
                        <p class="title">Edit Benchmark Index</p>
                    </div>
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            ...
                            <div class="box-content" style="background: #293b50 url({$BASE_URL}assets/New/img/pattern3.png) repeat !important;">
                                 <form action="" method="post" onsubmit="return ValidateForm();"  id="contact-form" class="form-horizontal" enctype="multipart/form-data">
               ...
               <p>   {field data=$item value=$postData}{/field}
                                    ...
                                    <button type="submit" class="btn btn-primary" name="submit" id="submit"><i class="icon-ok"></i> Save</button>
                                       <button type="button" class="btn" name="cancel" id="cancel"  onclick="document.location.href='{$BASE_URL}index.php?module=benchmarkindex2';">Back</button>
                                    </div>
