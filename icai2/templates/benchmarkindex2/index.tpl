                        ...
                        <div class="box">
                            <div class="box-content" style="background: #293b50 url({$BASE_URL}assets/New/img/pattern3.png) repeat !important;">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                      {if $sessData.User.type==1}  <a class="btn btn-circle show-tooltip" title="Add new record" href="index.php?module=benchmarkindex2&event=addNew"><i class="icon-plus"></i></a>
        ...
        <tr>
            ...
            <td style="width:145px !important;">
                <div class="btn-group">
                  ...
                  {if $sessData.User.type==1}      <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=benchmarkindex2&event=edit&id={$point.id}"><i class="icon-edit"></i></a>
