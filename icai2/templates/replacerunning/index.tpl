...
<table class="table table-advance" id="table1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{if $point.adminapprove==0}<span class="label label-important">No</span>{else}<span class="badge badge-success">Yes</span>{/if}</td> <td>{if $point.dbapprove==0}<span class="label label-important">No</span>{else}<span class="badge badge-success">Yes</span>{/if}</td>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <a class="btn btn-small show-tooltip" title="View" href="index.php?module=replacerunningsecurities&event=viewupcoming&id={$point.id}"><i class="icon-zoom-in"></i></a>
                   <!-- <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=replacerunningsecurities&event=editfornext&id={$point.id}"><i class="icon-edit"></i></a>-->
