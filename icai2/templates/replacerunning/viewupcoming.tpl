...
<div class="clearfix"></div>
                                 <div class="box">
                                 <div class="box-title">
                                <h3><i class="icon-table"></i>Total {$total2} securities added to add</h3>
                            </div>
                              </div>  
...
<table class="table table-advance">
 ...
 <a href="index.php?module=replacerunningsecurities&event=approvetemp&id={$viewindexdata.0.id}"><button class="btn btn-success">Approve</button></a> {/if}
 ...
 {if $viewindexdata.0.dbapprove==0 && $viewindexdata.0.adminapprove==1}<a href="index.php?module=replacerunningsecurities&event=dbapprove&id={$viewindexdata.0.id}">   <button class="btn btn-primary">Approve</button></a>{/if}
