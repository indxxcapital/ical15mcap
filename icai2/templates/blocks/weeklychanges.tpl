                                ...
                                <ul class="weekly-changes">
                                    <li>
                                        <p>
                                         <!--   <i class="icon-arrow-up light-green"></i>-->
                                            <span class="light-green">{$wchtotalActiveindxx}</span>
                                            New Index
                                        </p>
                                    </li>
                                    <li>
                                        <p>
                                         <!--   <i class="icon-minus light-blue"></i>-->
                                            <span class="light-green">{$wchtotalca}</span>
                                    ...
                                    <li>
                                        <p>
                                            ...
                                            <span class="light-green">{$wchtotalTicker}</span>
                                            New Securities
                                        </p>
                                    </li>
                                    <li>
                                        <p>
                                           <!-- <i class="icon-arrow-up light-green"></i>-->
                                            <span class="light-green">{$wchtotalcavals}</span>
