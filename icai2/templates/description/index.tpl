...
<table class="table table-advance" id="table1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                    <!--<a class="btn btn-small show-tooltip" title="View Indexes" href="index.php?module=description&event=view&id={$point.userid}"><i class="icon-zoom-in"></i></a>-->
                    <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=description&event=edit&id={$point.id}"><i class="icon-edit"></i></a>
