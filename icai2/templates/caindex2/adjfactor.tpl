 ...
 <div class="col-lg-4 col-md-4 col-sm-4">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="thumb-pad2">
                <div class="thumbnail"> 
                <div class="caption">
                        <p class="title">Submit Adjacent Factor for {$postData.ticker} ({$postData.isin})</p>
                    </div>
...
<div class="row-fluid">
               ...
               <p>   {field data=$item value=$postData}{/field}
                                    ...
                                    <button type="submit" class="btn btn-primary" name="submit" id="submit"><i class="icon-ok"></i> Save</button>
                                       <button type="button" class="btn" name="cancel" id="cancel"  onclick="document.location.href='{$BASE_URL}index.php?module=caindex2&event=view&id={$smarty.get.indxx_id}';">Back</button>
                                    </div>
