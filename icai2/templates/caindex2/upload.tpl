...
<table class="table table-advance" id="table1">
    ...
    <tbody>
    	{foreach from=$uploadsecuritydata item=point key=k}
        <tr>
            ...
            <td>
                <div class="btn-group">
                    <a class="btn btn-small show-tooltip" title="View" href="index.php?module=caindex&event=view&id={$point.id}"><i class="icon-zoom-in"></i></a>
                    <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=caindex&event=edit&id={$point.id}"><i class="icon-edit"></i></a>
                    <a class="btn btn-small btn-danger show-tooltip " title="Delete" href="index.php?module=caindex&event=delete&id={$point.id}" id="a1" onclick="confirmdelete()"><i class="icon-trash"></i></a>
                </div>
            </td>
        </tr>
        {/foreach}
