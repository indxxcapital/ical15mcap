 ...
 var temp=confirm("Are you sure you want to delete this record ")
  if(temp)
   {	
	...
	window.location.href='index.php?module=benchmarkindex&event=delete&id='+id;
	}
	else{
	return false;
	}
...
$.ajax({
    ...
    success: function(data, textStatus, jqXHR)
    {
		...
		window.location.href='index.php?module=benchmarkindex';
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-table"></i>Benchmark Index</h3>
                            </div>
                            <div class="box-content">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                      {if $sessData.User.type==1}  <a class="btn btn-circle show-tooltip" title="Add new record" href="index.php?module=benchmarkindex&event=addNew"><i class="icon-plus"></i></a>
                                         <a class="btn btn-circle show-tooltip" title="Delete selected" id="deleteSelected" href="#"><i class="icon-trash"></i></a>{/if}
                                          <a class="btn btn-circle show-tooltip" title="Export to Excel" href="index.php?module=benchmarkindex&event=exportExcel"><i class="icon-table"></i></a>
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                  ...
                  {if $sessData.User.type==1}      <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=benchmarkindex&event=edit&id={$point.id}"><i class="icon-edit"></i></a>
