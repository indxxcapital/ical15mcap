 ...
 var temp=confirm("Are you sure you want to delete this record ")
  if(temp)
   {	
	...
	window.location.href='index.php?module=viewca2&event=delete&id='+id;
	}
	else{
	return false;
	}
...
$.ajax({
    url : "index.php?module=viewca2&event=deleteindex",
    type: "POST",
    data : parameters,
 ...
 <div class="col-lg-4 col-md-4 col-sm-4">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="thumb-pad2">
                <div class="thumbnail"> 
                <div class="caption">
                        <p class="title">Corporate Actions</p>
                    </div>
...
<!--            <td><a data-original-title="{$point.mnemonic}" data-content="{$sessData.variable[$point.mnemonic]}" data-placement="top" data-trigger="hover" class="show-popover" href="#">{$point.mnemonic}</a></td>-->
            ...
            <td style="width:145px !important;">
                <div class="btn-group">
                    <a class="btn btn-small show-tooltip" title="View Fields" href="index.php?module=viewca2&event=view&id={$point.id}"><i class="icon-zoom-in"></i></a>
                    
                    {if $sessData.User.type==1}
                    
                    <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=viewca2&event=edit&id={$point.id}"><i class="icon-edit"></i></a>
                    <a class="btn btn-small btn-danger show-tooltip " title="Delete" href="#" id="a1" onclick="confirmdelete({$point.id})"><i class="icon-trash"></i></a>{/if}
                </div>
            </td>
        </tr>
        {/foreach}
