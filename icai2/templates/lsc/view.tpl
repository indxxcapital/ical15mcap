...
<table class="table table-advance">
 ...
 {if $indxxdata.0.status!=1}
  <a href="index.php?module=lsc&event=approve&id={$indxxdata.0.id}"><button class="btn btn-primary">Approve</button></a>
                                   
 {/if}
 
 
   <a href="index.php?module=lsc&event=delete&id={$indxxdata.0.id}"><button class="btn btn-inverse">Delete</button></a>
