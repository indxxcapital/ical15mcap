...
$.ajax({
    ...
    {
	  window.location.href='index.php?module=delisttempupcoming';
                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                        <a class="btn btn-circle show-tooltip" title="Add new record" href="index.php?module=delisttempupcoming&event=addNew" ><i class="icon-plus"></i></a>
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <a class="btn btn-small show-tooltip" title="View" href="index.php?module=delisttempupcoming&event=viewupcoming&id={$point.id}"><i class="icon-zoom-in"></i></a>
                   <!-- <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=delisttempupcoming&event=editfornext&id={$point.id}"><i class="icon-edit"></i></a>-->
