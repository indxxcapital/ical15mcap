...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-reorder"></i>Submit Adjacent Factor for {$postData.ticker} ({$postData.isin})</h3>
                                                </div>
               ...
               <p>   {field data=$item value=$postData}{/field}
                                    ...
                                    <button type="submit" class="btn btn-primary" name="submit" id="submit"><i class="icon-ok"></i> Save</button>
                                       <button type="button" class="btn" name="cancel" id="cancel"  onclick="document.location.href='{$BASE_URL}index.php?module=caindex&event=view&id={$smarty.get.indxx_id}';">Back</button>
                                    </div>
