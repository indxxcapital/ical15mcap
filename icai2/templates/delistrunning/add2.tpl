...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-reorder"></i>Select Securities To Delist </h3>
                            </div>
...
{/if}
                 ...
                 <div class="form-actions">
                                       ...
                                       <button type="button" class="btn" name="cancel" id="cancel"  onClick="document.location.href='{$BASE_URL}index.php?module=delisttempupcoming';">Back</button>
                                    </div>
