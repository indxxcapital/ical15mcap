...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-table"></i>{$indexdata|@count} Securities</h3>
                            </div>
...
<table class="table table-advance" id="table1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                    <a class="btn btn-small show-tooltip" title="View Corporate Actions" href="index.php?module=viewca&event=index&ticker_id={$point.ticker}"><i class="icon-zoom-in"></i></a>
                   <!-- <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=casecurities&event=edit&id={$point.id}"><i class="icon-edit"></i></a>
