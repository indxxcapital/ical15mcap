                        ...
                        <div class="box box-magenta">
                            ...
                            <div class="form-actions">
                                       ...
                                       <!--  <button class="btn btn-primary"  id="addScnt" type="submit" onclick="document.location.href='{$BASE_URL}index.php?module=caindex&event=viewupcoming&id={$sessData.NewIndxxId}';"><i class="icon-plus"></i>View</button>-->
                                          ...
                                          <button class="btn btn-primary" name='submit' value="submit" type="submit" onclick="document.location.href='{$BASE_URL}index.php?module=caindex&event=subindextemp&id={if $sessData.tempindexid}{$sessData.tempindexid}{else}{$sessData.NewIndxxId}{/if}';"><i class="icon-ok"></i> Submit Index for Approval</button>
