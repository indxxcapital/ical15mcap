...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-reorder"></i>Add New Security {if $sessData.indxx_code} for index {$sessData.indxx_code} {/if}</h3>
                            </div>
 ...
 <p>
                 ...
                 <div class="form-actions">
                                       ...
                                       <button type="submit" class="btn btn-primary" name="submitindex" value="submitindex" id="submit"><i class="icon-ok"></i>Submit Index</button>
