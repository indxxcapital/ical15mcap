...
$.ajax({
    ...
    {
	  window.location.href='index.php?module=replacetempupcoming';
                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                        <a class="btn btn-circle show-tooltip" title="Add new record" href="index.php?module=replacetempupcoming&event=addNew" ><i class="icon-plus"></i></a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{if $point.status==0}<span class="label label-important">No</span>{else}<span class="badge badge-success">Yes</span>{/if}</td>            
             <td>{if $point.dbapprove==0}<span class="label label-important">No</span>{else}<span class="badge badge-success">Yes</span>{/if}</td>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <a class="btn btn-small show-tooltip" title="View" href="index.php?module=replacetempupcoming&event=viewupcoming&id={$point.id}"><i class="icon-zoom-in"></i></a>
                   <!-- <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=replacetempupcoming&event=editfornext&id={$point.id}"><i class="icon-edit"></i></a>-->
