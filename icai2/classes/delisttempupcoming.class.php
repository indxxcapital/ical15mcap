...
class Delisttempupcoming extends Application{
...
$this->addJs('js/flaty.js');
	...
	$this->_bodyTemplate="delisttempupcoming/index";
...
//	$this->addfield();
	...
	protected function editfornext(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="delisttempupcoming/edit";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
		...
		if(isset($_POST['submit']))
		{
			...
			$this->Redirect("index.php?module=delisttempupcomingsecurities&event=edit2&id=".$tempindexid,"Index updated successfully!!!<br> Please update associated securities!!!","success");
...
function addNew3()
	{
			$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="delisttempupcoming/add3";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
			...
			if($added>=1)
		{
			...
			$this->Redirect("index.php?module=delisttempupcomingsecurities&event=addNewNext&total=".$added."&id=".$_GET['indxx_id']."reqid=".$_GET['reqid'],"Index added successfully!!! <br> Please Wait for Approval","success");	
		}
		else
		{
			$this->Redirect("index.php?module=delisttempupcomingsecurities&event=addNew2","No security added!!! <br> Please add again","error");	
		}
		}
...
///echo "deepak";
		...
		//$this->pr($_SESSION,true);
			$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="delisttempupcoming/editrunning";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
	...
	$tempShareArray[$share['isin']]=$share['share'];
		...
		if($_POST['submit'])
		{
			...
			if($added>=1)
		{
			$this->Redirect("index.php?module=delisttempupcomingsecurities&event=addedrunning&id=".$added,"Index added successfully!!! <br> Please Wait for Approval","success");	
		}
		else
		{
			$this->Redirect("index.php?module=delisttempupcomingsecurities&event=addNew2","No security added!!! <br> Please add again","error");	
	...
	function edit2()
	{
		//$this->pr($_SESSION,true);
			$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="delisttempupcoming/add2";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
		...
		if($_POST['submit'])
		{
			...
			if($added>=1)
		{
			$this->Redirect("index.php?module=delisttempupcomingsecurities&event=addNewNext&id=".$added,"Index added successfully!!! <br> Please Wait for Approval","success");	
		}
		else
		{
			$this->Redirect("index.php?module=delisttempupcomingsecurities&event=addNew2","No security added!!! <br> Please add again","error");	
	...
	if(isset($_POST['submit']))
	{
		...
		{	
			$check=$this->db->getResult("select tbl_delist_tempsecurity.* from tbl_delist_tempsecurity where  security_id='".$ca_id."' and req_id='".$_GET['reqid']."' and indxx_id='".$_GET['id']."'");
		...
		$this->db->query("INSERT into tbl_delist_tempsecurity set status='1',security_id='".$ca_id."', indxx_id='".$_GET['id']."', req_id='".$_GET['reqid']."'");
		...
		$this->Redirect("index.php?module=delisttempupcomingsecurities&event=addNewNext&indxx_id=".$_GET['id']."&reqid=".$_GET['reqid'],"Securities to be delisted added successfully!!! <br> Please Wait for Approval","success");
	}
...
{	   
	...
	{
			$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="delisttempupcoming/add";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
		...
		if(isset($_POST['submit']))
		{
			...
			$this->Redirect("index.php?module=delisttempupcomingsecurities&event=addNew2&id=".$_POST['indxx_id']."&reqid=".$reqid,"Index added successfully!!!","success");	
		}
...
function addedrunning()
{
	...
	//$this->pr($indexdata,true);
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="delisttempupcoming/addedrunning";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
	...
	{
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="delisttempupcoming/addnext";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
	...
	$this->getValidFeilds();
	 ...
	 protected function view(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="delisttempupcoming/view";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
	...
	//	$this->pr($sequruityData,true);
		...
		protected function delete(){
		 ...
		 //$this->_baseTemplate="inner-template";
			//$this->_bodyTemplate="delisttempupcoming/delete";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
...
$body='Hi <br>';
$body.='Your Indxx '.$indxx['name'].'('.$indxx['code'].') has been deleted by admin , <br> Please  <a href="'.$this->siteconfig->base_url.'index.php?module=delisttempupcomingsecurities">Click here </a> to do more.<br>Thanks ';
		...
		$strQuery = "delete from tbl_delist_tempindex_req where tbl_delist_tempindex_req.id='".$_GET['id']."'";
			...
			$this->Redirect("index.php?module=delisttempupcomingsecurities","Index deleted successfully!","success");
	...
	//	echo "select * tbl_indxx_temp where tbl_indxx_temp.id='".$_GET['id']."'";
		...
		{
				$this->Redirect("index.php?module=delisttempupcomingsecurities","You are not authorized to perofrm this task!","error");
		}
		else
		{
			$strQuery = "delete from tbl_delist_tempindex_req where tbl_delist_tempindex_req.id='".$_GET['id']."'";
...
$headers .= 'From: Indexing <indexing@indxx.com>' . "\r\n";
$body='Hi <br>';
$body.='Your Upcoming Indxx '.$indxx['name'].'('.$indxx['code'].') has been deleted by admin , <br> Please  <a href="'.$this->siteconfig->base_url.'index.php?module=delisttempupcomingsecurities">Click here </a> to do more.<br>Thanks ';
...
$body='Hi <br>';
$body.='You have new indxx for Delisting, <br> Please  <a href="'.$this->siteconfig->base_url.'index.php?module=delisttempupcomingsecurities&event=viewupcoming&id='.$_GET['reqid'].'">Click here </a> to check it.<br>Thanks ';
		...
		$this->Redirect("index.php?module=delisttempupcomingsecurities","Record updated successfully!!!","success");	
		}
		else
		{
				$this->Redirect("index.php?module=delisttempupcomingsecurities","You are not authorized to perofrm this task!","error");
	...
	protected function viewupcoming(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="delisttempupcoming/viewupcoming";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
		...
		$securitytobedelisted=$this->db->getResult("select tbl_indxx_ticker_temp.* from tbl_delist_tempsecurity left join tbl_indxx_ticker_temp on tbl_indxx_ticker_temp.id=tbl_delist_tempsecurity.security_id  where tbl_delist_tempsecurity.req_id='".$_GET['id']."' and  tbl_delist_tempsecurity.indxx_id='".$viewdata[0]['indxx_id']."'",true);
	...
	protected function approvetemp(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="delisttempupcoming/approve";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
