...
$finalArray=array();
	...
	{
		//
	if(!empty($ca)&&  !empty($ca['newTickers']))
	{
...
//echo "<br>";
	...
	$insertWeightQuery="Insert into tbl_weights_temp set dateAdded='".$date."',isin='".$newTicker['isin']."',date='".$newTicker['lastday']."',price='0',share='".$currentShare."', 	weight='0', indxx_id='".$newTicker['indxx_id']."',code='".$newTicker['indxx_code']."' ";
...
//	$this->Redirect("index.php?module=calcrebalance","","");	
	$this->Redirect("index.php?module=calccadp&log_file=".basename(log_file)."&date=".date,"","");	
	}
}