...
class Viewfields extends Application{
...
$this->addJs('js/flaty.js');
	...
	$this->getValidFeilds();
	 ...
	 protected function view(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="viewfields/view";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
...
$this->addJs('js/flaty.js');
	...
	protected function edit(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="viewfields/edit";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
	...
	protected function delete(){
		...
		$strQuery = "delete from tbl_ca_values where tbl_ca_values.id='".$_GET['id']."'";
			...
			$this->Redirect("index.php?module=viewfields","Records deleted successfully!!!","success");
