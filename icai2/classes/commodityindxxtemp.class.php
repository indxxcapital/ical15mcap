...
class Commodityindxxtemp extends Application{
...
$this->addJs('js/flaty.js');
	...
	$this->_bodyTemplate="commodityindxxtemp/index";
			$this->_title='Commodity Index';
	$indxxdata=$this->db->getResult("select * from tbl_commodity_indxx_temp",true);
	...
	{
			$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="commodityindxxtemp/add";
	...
	$_SESSION['CSI']=$_POST;
			...
			$this->Redirect("index.php?module=commodityindxxtemp&event=addAdjfactor","Please Select Index and Submit Weight !!!","success");	
		}
...
//	$this->pr($_SESSION,true);
	...
	$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="commodityindxxtemp/addnext";
	...
	exit;
		...
		$this->db->query("INSERT into tbl_commodity_indxx_temp set status='0', name='".mysql_real_escape_string($_SESSION['CSI']['name'])."',code='".mysql_real_escape_string($_SESSION['CSI']['code'])."',zone='".mysql_real_escape_string($_SESSION['CSI']['zone'])."',client_id='".mysql_real_escape_string($_SESSION['CSI']['client_id'])."',datestart='".mysql_real_escape_string($_SESSION['CSI']['dateStart'])."',user_id='".mysql_real_escape_string($_SESSION['User']['id'])."'");
...
//	$indxxdata=$this->db->getResult("select code from tbl_indxx where id = '".$index_id."' ",false,1);
	...
	$this->db->query("INSERT into tbl_commodity_indxx_ticker_temp set indxx_id='".mysql_real_escape_string($newIndxx_id)."',ticker_id='".mysql_real_escape_string($index_id)."',weight='".mysql_real_escape_string($_POST['fraction'][$index_key])."'");
//	$this->pr($_SESSION['CSI']);
	//$this->pr($indxxdata);
	}
...
//	$this->pr($_POST,true);
	...
	//$_SESSION['CSI']=$_POST;
			...
			$this->Redirect("index.php?module=commodityindxxtemp","Record added successfully!!!","success");	
		}
	...
	function edit()
	{
		...
		$tickerdata=$this->db->getResult("select tbl_commodity_indxx_ticker_temp.* from tbl_commodity_indxx_ticker_temp where indxx_id='".$_GET['id']."' ",true);
	...
	//echo "updated tbl_commodity_indxx_temp set status='0' where  id ='".$_GET['id']."'";
	//exit;
		$this->db->query("update tbl_commodity_indxx_temp set status='0' where  id ='".$_GET['id']."'");
//	$this->pr($_SESSION['CSI']);
	//$newIndxx_id=mysql_insert_id();
	$strQuery = "delete from tbl_commodity_indxx_ticker_temp where indxx_id='".$_GET['id']."'";
					$this->db->query($strQuery);
	foreach($_POST['indxx_id'] as $index_key=>$index_id)
	{
	//$indxxdata=$this->db->getResult("select code from tbl_indxx where id = '".$index_id."' ",false,1);
	
	$this->db->query("INSERT into tbl_commodity_indxx_ticker_temp set indxx_id='".mysql_real_escape_string($_GET['id'])."',ticker_id='".mysql_real_escape_string($index_id)."',weight='".mysql_real_escape_string($_POST['fraction'][$index_key])."'");
...
//	$this->pr($_POST,true);
	...
	//$_SESSION['CSI']=$_POST;
			...
			$this->Redirect("index.php?module=commodityindxxtemp","Record Updated  successfully!!!<br> Please Wait for Admin Approval.","success");	
		}
...
{	   
	...
	protected function delete(){
		 	...
		 	$strQuery1 = "delete from tbl_commodity_indxx_temp where id='".$_GET['id']."'";
			...
			$this->Redirect("index.php?module=commodityindxxtemp","Record deleted successfully!!!","success");
		...
		function deleteindex()
	{
		...
		$this->Redirect("index.php?module=commodityindxxtemp","Records deleted successfully!!!","success");
		$this->show();	
	}
	...
	function view()
{
	...
	$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="commodityindxxtemp/view";
			$this->_title="View Commodity Index";
	
	$indxxdata=$this->db->getResult("select * from tbl_commodity_indxx_temp where id = '".$_GET['id']."' ",true);
	

	
	$indxxfactordata=$this->db->getResult("select * from tbl_commodity_indxx_ticker_temp where indxx_id = '".$_GET['id']."' ",true);
...
$indxxfactordata[$key]['name']=$indxxname['name'];
	...
	$indxxdata=$this->db->getResult("select * from tbl_commodity_indxx_temp where id = '".$_GET['id']."' ",false,1);
	
	//$this->pr($indxxdata,true);
	
			
			
			$strQuery1 = "update tbl_commodity_indxx_temp set status='1' where id='".$_GET['id']."'";
					$this->db->query($strQuery1);
...
//exit;
	...
	$this->Redirect("index.php?module=commodityindxxtemp","Records Approved successfully!!!","success");
	}
