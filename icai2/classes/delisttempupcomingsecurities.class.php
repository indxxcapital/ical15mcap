...
class delisttempupcomingsecurities extends Application{
...
function addedrunning()
{
	...
	function addNewNext()
	{
		...
		$indexname=$this->db->getResult("select tbl_indxx_temp.name as indexxname,tbl_delist_tempindex_req.* from tbl_indxx_temp left join  tbl_delist_tempindex_req on tbl_delist_tempindex_req.indxx_id=tbl_indxx.id where tbl_delist_tempindex_req.id='".$_GET['reqid']."' ",true);
