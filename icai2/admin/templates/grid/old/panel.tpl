...
<tbody>
	...
	{foreach from=$gridData item=dataList key=k}	
			...
			{if $gridItemDiabled.status} 	
				<a href="javascript:updateRecord('{$dataList.id}','{$smarty.capture.statusCurrent}','{$k}')" class='a2'>
               
               
                <img src="assets/images/{$smarty.capture.statusImage}" width="16" height="16"  /></a>
