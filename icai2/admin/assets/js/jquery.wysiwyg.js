...
(function( $ )
{
    ...
    $.fn.wysiwyg = function( options )
    {
        ...
        var options = $.extend({
            html : '<'+'?xml version="1.0" encoding="UTF-8"?'+'><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">STYLE_SHEET</head><body><p>INITIAL_CONTENT</p></body></html>',
            css  : {},
    ...
    $.extend(Wysiwyg.prototype,
    {
        ...
        initFrame : function()
        {
            var self = this;
            var style = '';
			var attachstyle = 'css/jquery.wysiwyg.css';
            /**
             * @link http://code.google.com/p/jwysiwyg/issues/detail?id=14
             */
            if ( attachstyle )
                style = '<link rel="stylesheet" type="text/css" media="screen" href="' + attachstyle + '" />';
