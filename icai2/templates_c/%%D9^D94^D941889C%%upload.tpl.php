<?php /* Smarty version 2.6.14, created on 2015-12-08 04:35:13
         compiled from uploadmarketcap/upload.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'field', 'uploadmarketcap/upload.tpl', 19, false),)), $this); ?>
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-table"></i>Upload Market cap</h3>
                                <div class="box-tool">
                                </div>
                            </div>
