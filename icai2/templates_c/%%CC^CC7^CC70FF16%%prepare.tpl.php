<?php /* Smarty version 2.6.14, created on 2015-08-18 09:43:29
         compiled from reconstitution/prepare.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'field', 'reconstitution/prepare.tpl', 19, false),)), $this); ?>
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-table"></i>Upload File for generating Input Files</h3>
                                <div class="box-tool">
                                </div>
                            </div>
