<?php /* Smarty version 2.6.14, created on 2015-08-20 08:34:29
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-table"></i>Users</h3>
                            </div>
...
" /></td>
            ...
            <td><?php if ($this->_tpl_vars['point']['type'] == '1'): ?>Admin<?php else: ?>Normal<?php endif; ?></td>
            <td><a href="index.php?module=users&event=view&id=<?php echo $this->_tpl_vars['point']['userid']; ?>
