<?php /* Smarty version 2.6.14, created on 2015-12-09 02:07:13
         compiled from delistrunningsecuritiesnew/viewupcoming.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'delistrunningsecuritiesnew/viewupcoming.tpl', 145, false),)), $this); ?>
<!-- BEGIN Main Content -->
 <?php echo '
 ...
 var temp=confirm("Are you sure you want to delete this record ! All index related data will be deleted!")
  if(temp)
   {	
	...
	window.location.href=\'index.php?module=';  echo $this->_tpl_vars['currentClass'];  echo '&event=delete&id=\'+id;
	}
	else{
	return false;
	}
...
$.ajax({
    url : "index.php?module=';  echo $this->_tpl_vars['currentClass'];  echo '&event=deleteindex",
    type: "POST",
    data : parameters,
...
<table class="table table-advance">
    ...
    <?php if (count($this->_tpl_vars['securitytobedelisted']) > 0): ?>
    	<?php $_from = $this->_tpl_vars['securitytobedelisted']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['point']):
?>
        <tr>
...
&event=approvetemp&id=<?php echo $this->_tpl_vars['viewindexdata']['0']['id']; ?>
"><button class="btn btn-success">Approve</button></a> <?php endif; ?>
 

                                    <a href="index.php?module=<?php echo $this->_tpl_vars['currentClass']; ?>
"><button class="btn btn-inverse">Back</button></a>
...
"><button class="btn btn-inverse">Back</button></a>
 ...
 <?php if ($this->_tpl_vars['viewindexdata']['0']['dbapprove'] == 0 && $this->_tpl_vars['viewindexdata']['0']['adminapprove'] == 1): ?><a href="index.php?module=<?php echo $this->_tpl_vars['currentClass']; ?>
&event=dbapprove&id=<?php echo $this->_tpl_vars['viewindexdata']['0']['id']; ?>
