<?php /* Smarty version 2.6.14, created on 2015-08-18 09:57:53
         compiled from delisttempupcoming/index.tpl */ ?>
<!-- BEGIN Main Content -->
...
" /></td>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <a class="btn btn-small show-tooltip" title="View" href="index.php?module=delisttempupcoming&event=viewupcoming&id=<?php echo $this->_tpl_vars['point']['id']; ?>
"><i class="icon-zoom-in"></i></a>
                   <!-- <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=delisttempupcoming&event=editfornext&id=<?php echo $this->_tpl_vars['point']['id']; ?>
