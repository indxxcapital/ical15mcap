<?php /* Smarty version 2.6.14, created on 2015-12-09 02:07:10
         compiled from delistrunningsecuritiesnew/index.tpl */ ?>
<!-- BEGIN Main Content -->
...
$.ajax({
    ...
    {
	  window.location.href=\'index.php?module=';  echo $this->_tpl_vars['currentClass'];  echo '\';
                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                        <a class="btn btn-circle show-tooltip" title="Add new record" href="index.php?module=<?php echo $this->_tpl_vars['currentClass']; ?>
&event=addNew" ><i class="icon-plus"></i></a>
...
" /></td>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <a class="btn btn-small show-tooltip" title="View" href="index.php?module=<?php echo $this->_tpl_vars['currentClass']; ?>
&event=viewupcoming&id=<?php echo $this->_tpl_vars['point']['id']; ?>
