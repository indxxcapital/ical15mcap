<?php /* Smarty version 2.6.14, created on 2015-12-10 09:38:03
...
?>
             <?php if ($this->_tpl_vars['p']%14 == 0): ?>  <div class="controls step controls-row">
                                    <span class="formnumber"><?php echo $this->_tpl_vars['p']/14+1; ?>
</span>
            <?php endif; ?>                         <?php $this->_tag_stack[] = array('field', array('data' => $this->_tpl_vars['item'],'value' => $this->_tpl_vars['postData'])); $_block_repeat=true;smarty_block_field($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start();  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_field($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
                ...
                <?php if ($this->_tpl_vars['p']%14 == 13): ?>  </div><?php endif; ?>                    
...
$(function() {
        ...
        $(\'#addScnt\').click( function() {
             $(\'<div class="controls step  controls-row"> <span class="formnumber">\'+i+\'</span><input type="text" placeholder="Security Name" class="span1" name="name[\'+i+\']"><input type="text" name="isin[\'+i+\']" placeholder="ISIN" class="span1"><input  name="ticker[\'+i+\']" type="text" placeholder="Security Ticker" class="span1"><input '; ?>
  <?php if ($this->_tpl_vars['runningindexdata']['status'] == 1 && $this->_tpl_vars['runningindexdata']['dbusersignoff'] == 1): ?> type="text"<?php else: ?> type="hidden"<?php endif;  echo ' placeholder="Share"  name="share[\'+i+\']" class="span1"><input name="weight[\'+i+\']" type="text" placeholder="Weight" class="span1"><input name="curr[\'+i+\']" type="text" placeholder="Ticker Currency" class="span1"><input name="divcurr[\'+i+\']" type="text" placeholder="Dividend Currency" class="span1"><input name="sedol[\'+i+\']" type="text" placeholder="Sedol" class="span1"><input name="cusip[\'+i+\']" type="text" placeholder="Cusip" class="span1"><input name="countryname[\'+i+\']" type="text" placeholder="Country Name" class="span1"><input name="sector[\'+i+\']" type="text" placeholder="Sector" class="span1"><input name="industry[\'+i+\']" type="text" placeholder="Inustry" class="span1"><input name="subindustry[\'+i+\']" type="text" placeholder="SubInustry" class="span1">\').appendTo(scntDiv);
                $(\'#totalfields\').val(i);
				i++;
                return false;
        });
